                                    ...
                                    <div className="w-full">
                                        ...
                                        >
                                            <DialogTrigger asChild>
                                                <Button
                                                    className="w-full bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 hover:from-cyan-500 hover:via-blue-500 hover:to-purple-500 text-white border-0 shadow-xl shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all duration-300 py-3 font-semibold"
                                                    onClick={() => {
                                                        setCurrentPolicy(
                                                            policy
                                                        );
