            ...
            <main className="relative z-10 pt-32 pb-20 px-4">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
                        Nova Protocol is a modular, AI-powered protocol securing
                        DeFi, bridges, wallets, and smart contracts across
                        chains.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                        ...
                        <Button
                            variant="outline"
                            className="bg-gray-800/50 text-white border-gray-600/50 hover:bg-gray-700/50 hover:text-white px-8 py-3 rounded-xl font-semibold text-lg"
                        >
                            Stake as LP
                        </Button>
                        <Button
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        <div className="bg-gray-800/30 backdrop-blur-lg border border-gray-700/50 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
                            ...
                            <p className="text-gray-400">
                                Advanced algorithms continuously monitor and
                                assess risks across multiple blockchain
                                networks.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-800/30 backdrop-blur-lg border border-gray-700/50 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
                            ...
                            <p className="text-gray-400">
                                Seamless protection across Ethereum, Polygon,
                                Avalanche, and other major networks.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-800/30 backdrop-blur-lg border border-gray-700/50 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
                            ...
                            <p className="text-gray-400">
                                Automated claim processing with smart contracts
                                for rapid payouts when conditions are met.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="max-w-6xl mx-auto px-4 py-16">
                        <div className="grid md:grid-cols-4 gap-8 mb-12">
                            ...
                            <div className="md:col-span-1">
                                ...
                                <p className="text-gray-400 mb-6 leading-relaxed">
                                    ...
                                    AI-powered autonomous coverage across all
                                    major blockchains.
                                </p>
                        ...
                        <div className="bg-gray-800/30 backdrop-blur-lg border border-gray-700/50 rounded-2xl p-8 mb-12">
                            <div className="max-w-2xl mx-auto text-center">
                                ...
                                <p className="text-gray-400 mb-6">
                                    Get the latest updates on new insurance
                                    products, protocol upgrades, and security
                                    insights.
                                </p>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-700/50">
                            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-gray-400 text-sm">
                                <p>
                                    &copy; 2024 Nova Protocol Protocol. All
                                    rights reserved.
                                </p>
